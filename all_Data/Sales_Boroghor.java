...
public class Sales_Boroghor implements Runnable{
	...
	private boolean isWindowOverlayedSalesBoroghor = false;
	
//	private int numberOfRows = 88;
	private int numberOfRows = MainWindow.filesBoroghor.size(); //Dynamic Loading. Changed on: 2023-06-21.
	...
	private void initialize() {
		...
		btnGenerateTable.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//New Updated
				isWindowOverlayedSalesBoroghor = false;
			}
		});
	...
	public void frame_windowStateChanged_HasFocus(WindowEvent e) {
		if(frmSalesSheetBoroghor.isFocused() && (!MainWindow.modifiedRowVectorStockBoroghor.isEmpty() || !isWindowOverlayedSalesBoroghor)) {
			Thread object = new Thread(this); 
	        object.start();
//	        System.out.println("sales sheet focused");
		}
	}
	
	public void frame_windowStateChanged_LostFocus(WindowEvent e) {
		if(!MainWindow.modifiedRowVectorStockBoroghor.isEmpty()) {
			isWindowOverlayedSalesBoroghor = false;
		}
		else
		isWindowOverlayedSalesBoroghor = true;
	}
