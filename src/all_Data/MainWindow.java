...
public class MainWindow {
	...
	public static int threshold = 450; //Used for auto clear.
	
	static List<String> filesSenpara = new ArrayList<String>(); //Changed on: 2023-06-08.
	static List<String> senparaColors = new ArrayList<String>(); //Changed on: 2023-06-16.
...
//	};
	...
	static List<String> filesBoroghor = new ArrayList<String>(); //Changed on: 2023-06-10
	static List<String> boroghorColors = new ArrayList<String>(); //Changed on: 2023-06-16.
...
//};
	...
	public MainWindow() {
		Object obj[] = readJsonFile("Senpara");
		filesSenpara = (List<String>) obj[0];
//		System.out.println(filesSenpara);
		senparaColors = (List<String>) obj[1];

		
//		System.out.println(filesSenpara);
		obj = readJsonFile("Boroghor");
		filesBoroghor = (List<String>) obj[0];
//		System.out.println(filesBoroghor2);
		boroghorColors = (List<String>) obj[1];
	...
	public Object[] readJsonFile(String param) {
		List<String> fileNames = new ArrayList<String>();
		List<String> fileColors = new ArrayList<String>();
...
//	    	 System.out.println(filesSenpara);
	   ...
	   return new Object[] {fileNames, fileColors};
	}
}
